  ...
  try {
    await db.promise().query(
      `UPDATE applicants SET 
        ...
        a_gender = ?, a_birthdate = ?, a_contact = ?, 
        a_phone = ?, a_email = ? WHERE applicant_id = ?`,
...
/** ✅ เพิ่ม Portfolio ใหม่แยก (POST /:id/portfolio) */
...
/** ✅ ลบ portfolio ทั้งหมดของผู้สมัคร */
